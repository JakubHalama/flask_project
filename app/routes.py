...
class FilmForm(FlaskForm):
    ...
    rok_vydani = StringField('Director', validators=[InputRequired(message="Director is required"), Length(max=100)])
    popis_filmu = StringField('Description', validators=[InputRequired(message="Description is required"), Length(max=1000)])
